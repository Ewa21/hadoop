...
public class PopularityLeague extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        Job jobA = Job.getInstance(conf, "pagecount");
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            while (tokenizer.hasMoreTokens()) {
                ...
                if (first) {
                    ...
                    for(String page : stopWords){
                        if(nextToken.equals(Integer.parseInt(page))){
    ...
    public static class TopLinksReduce extends Reducer<NullWritable, IntArrayWritable, IntWritable, IntWritable> {
        ...
        public void reduce(NullWritable key, Iterable<IntArrayWritable> values, Context context) throws IOException, InterruptedException {
            ...
            Integer iterator = 1;
            for (Pair<Integer, Integer> item : countToPageMap) {
                if(prev>0 && (!item.first.equals(prev))){
                    counter+=iterator;
                    iterator = 1;
                }
                else{
                ...
                IntWritable value = new IntWritable(counter);
